...
class ReminderDescriptionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     geofencingClient = LocationServices.getGeofencingClient(this)
        ...
        binding.removeGeofence.setOnClickListener {
            geofencingClient
                .removeGeofences(listOf(reminderItem.id))
                .addOnSuccessListener {
                    Toast.makeText(this, "Reminder removed Successfully", Toast.LENGTH_LONG).show()
                }
                .addOnFailureListener {
                    Log.d("ReminderDescActivity", "Reminder removing Fail")
                    Toast.makeText(this, "Reminder removing Fail", Toast.LENGTH_LONG).show()
                }
        }
    }
}
